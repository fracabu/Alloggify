        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="relative mx-auto p-6 border w-full max-w-lg shadow-lg rounded-md bg-white">
                <div className="text-center">
                    <h3 className="text-xl leading-6 font-bold text-gray-900" id="modal-title">⚠️ Conferma Invio Schedina</h3>
                    <div className="mt-2 px-4 py-2 bg-yellow-50 border border-yellow-200 rounded-md">
                        <p className="text-sm text-yellow-800">
                            <strong>Attenzione:</strong> Stai per inviare questa schedina al portale Alloggiati Web della Polizia di Stato.
                            Verrà prima eseguito un test di validazione automatico.
                        </p>
                    </div>
